...
static const _RogidriveMessage_type_support_symbol_names_t _RogidriveMessage_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rogidrive_msg, msg, RogidriveMessage)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, rogidrive_msg, msg, RogidriveMessage)),
  }
};
...
{
  return &::rogidrive_msg::msg::rosidl_typesupport_cpp::RogidriveMessage_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, rogidrive_msg, msg, RogidriveMessage)() {
  return get_message_type_support_handle<rogidrive_msg::msg::RogidriveMessage>();
}
