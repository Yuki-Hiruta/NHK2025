...
static const _RogidriveMultiArray_type_support_symbol_names_t _RogidriveMultiArray_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rogidrive_msg, msg, RogidriveMultiArray)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rogidrive_msg, msg, RogidriveMultiArray)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, rogidrive_msg, msg, RogidriveMultiArray)() {
  return &::rogidrive_msg::msg::rosidl_typesupport_c::RogidriveMultiArray_message_type_support_handle;
}
