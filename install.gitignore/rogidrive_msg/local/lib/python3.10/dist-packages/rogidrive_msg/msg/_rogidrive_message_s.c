...
bool rogidrive_msg__msg__rogidrive_message__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("rogidrive_msg.msg._rogidrive_message.RogidriveMessage", full_classname_dest, 53) == 0);
  }
  rogidrive_msg__msg__RogidriveMessage * ros_message = _ros_message;
  {  // name
...
{
  /* NOTE(esteve): Call constructor of RogidriveMessage */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("rogidrive_msg.msg._rogidrive_message");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "RogidriveMessage");
